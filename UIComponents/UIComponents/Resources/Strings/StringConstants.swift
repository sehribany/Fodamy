...
public enum L10n {
  public enum Components {
    public enum Action {
      ...
      public static let loginWarning = L10n.tr("Components", "Action.loginWarning", fallback: "Giriş yapmanız gereklidir.")
    }
    public enum Comment {
      /// Bir şeyler yazın..
      public static let placeholder = L10n.tr("Components", "Comment.placeholder", fallback: "Bir şeyler yazın..")
    }
  }
  public enum Error {
