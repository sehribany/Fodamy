...
extension FavoritesViewController {
    ...
    private func configureContents() {
        ...
        collectionView.register(CategoryWithRecipesCell.self, forCellWithReuseIdentifier: CategoryWithRecipesCell.identifier)
...
extension FavoritesViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: CategoryWithRecipesCell = collectionView.dequeueReusableCell(withReuseIdentifier: CategoryWithRecipesCell.identifier, for: indexPath) as! CategoryWithRecipesCell
        let cellViewModel = viewModel.cellItem(for: indexPath)
        cellViewModel.didSelectRecipe = { [weak self] recipe in
            self?.viewModel.didSelectRecipe(recipe: recipe)
        }
